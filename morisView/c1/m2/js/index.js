...
function nextPreg(btn){
	...
	if(tipoActividad == "6" || tipoActividad == "1"){
...
function terminarAct(){
	if(respuestas != null){
		...
		else if(tipoActividad == "6" || tipoActividad == "1"){
...
function addMetas(){
	var metitas = [];
	console.log(metasCounter);
	$('#contenedorCurso input[type="text"]').each(function(){
		metitas.push($(this).val());
	});
	if(metasCounter <= 1){
		metasArr[metasCounter] = metitas;
		metasCounter++;
		nextPreg();
	}
	else{
		respuestas = [];
		metasArr[metasCounter] = metitas;
		for(var i in metasArr){
			for(var j in metasArr[i]){
				respuestas.push(metasArr[i][j]);
			}
		}
		terminarAct();
	}
...
$(document).ready(function(){
	...
	$("#contenedor").on("change", 'input[type="text"]', function(){
		try{
			if(numDiap == 2){
				return;
			}
				...
				$(this).val(accounting.formatMoney(thisval));
			}
		}
		catch(e){
...
/*
 var campos = `<section>
							 ...
							 <input type="number" name="monto" min="1" step="any" />
							</section>`;
 $("#tabla").append(campos);*/
 }
				...
				return `
							<div id="tabla">
								<section>
									...
									<select class="periodo" data-meto="0">
										<option default disabled>Selecciona tu periodo de revision</option>
								...
								<section>
									...
									<select class="periodo" data-meto="1">
										<option default disabled>Selecciona tu periodo de revision</option>
										<option value="Semanal">Semanal</option>
										<option value="Quincenal">Quincenal</option>
										<option value="Mensual">Mensual</option>
								...
								<section>
									...
									<select class="periodo" data-meto="2">
										<option default disabled>Selecciona tu periodo de revision</option>
										<option value="Semanal">Semanal</option>
										<option value="Quincenal">Quincenal</option>
										<option value="Mensual">Mensual</option>
				...
				return `
							<div id="tabla">
								<section>
									...
									<select class="periodo" data-meto="3">
										<option default disabled>Selecciona tu periodo de revision</option>
										<option value="Semanal">Semanal</option>
										<option value="Quincenal">Quincenal</option>
										<option value="Mensual">Mensual</option>
								...
								<section>
									...
									<select class="periodo" data-meto="4">
										<option default disabled>Selecciona tu periodo de revision</option>
										<option value="Semanal">Semanal</option>
										<option value="Quincenal">Quincenal</option>
										<option value="Mensual">Mensual</option>
								...
								<section>
									...
									<select class="periodo" data-meto="5">
										<option default disabled>Selecciona tu periodo de revision</option>
										<option value="Semanal">Semanal</option>
										<option value="Quincenal">Quincenal</option>
										<option value="Mensual">Mensual</option>
				...
				return `
							<div id="tabla">
								<section>
									...
									<select class="periodo" data-meto="6">
										<option default disabled>Selecciona tu periodo de revision</option>
										<option value="Semanal">Semanal</option>
										<option value="Quincenal">Quincenal</option>
										<option value="Mensual">Mensual</option>
								...
								<section>
									...
									<select class="periodo" data-meto="7">
										<option default disabled>Selecciona tu periodo de revision</option>
										<option value="Semanal">Semanal</option>
										<option value="Quincenal">Quincenal</option>
										<option value="Mensual">Mensual</option>
								...
								<section>
									...
									<select class="periodo" data-meto="8">
										<option default disabled>Selecciona tu periodo de revision</option>
										<option value="Semanal">Semanal</option>
										<option value="Quincenal">Quincenal</option>
										<option value="Mensual">Mensual</option>
