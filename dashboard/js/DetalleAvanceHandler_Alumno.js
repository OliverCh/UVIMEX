var DetalleAvanceHandler_Alumno = (function(window, undefined){
	...
	var DetalleAvance_listEl = `
		<tr>
			...
			<td><button type="button" name="button" class="tddetallescAlum" data-id=":id:" data-name=":name:">Detalle</button></td>
		</tr>
		`;

	var detAvAl__userNick;
	var detAvAl__userName;

	var findFields = function(){
		detAvAl__userNick = $("#detAvAl__userNick");
		detAvAl__userName = $("#detAvAl__userName");
	};
	var fillFields = function(){		
		detAvAl__userNick.html(localStorage.getItem("nick"));
		detAvAl__userName.html(localStorage.getItem("name"));
	};
	...
	var showData = function(orgDataArr){
		...
		$("#genAdv__courses").html("");
		$("#genAdv__courses").append(html);
	}
